...
public class RecipeController {
	...
	public ResponseEntity<List<Ingredient>> aggregateIngredients(
			@RequestBody List<RecipeAndNoOfPeople> aggIngredientsRequest) {

		List<Ingredient> aggregatedIngredients = FoodPlannerUtils.aggregateIngredients(aggIngredientsRequest);
